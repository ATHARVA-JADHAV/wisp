    ...
    <div className="min-h-dvh bg-bg">
      <header className="glass-ios sticky top-0 z-40 border-x-0 border-t-0">
        <div className="mx-auto flex h-15 max-w-6xl items-center justify-between px-5 py-3">
          <div className="flex items-center gap-2 font-(family-name:--font-display) text-lg font-bold">
            ...
            <Link
              href="/dashboard"
              className="ml-1 rounded-md bg-black/[0.04] px-1.5 py-0.5 font-(family-name:--font-mono) text-[10px] font-normal text-muted transition hover:bg-black/[0.08] hover:text-fg"
            >
              dashboard
            </Link>
          </div>
